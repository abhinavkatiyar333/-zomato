...
const CreateFood = () => {
  ...
  const onSubmit = async (e) => {
    ...
    formData.append("video", videoFile); // Matches your backend route
    ...
    try {
        ...
        // This will now show you the SPECIFIC error from your backend terminal
        console.error("Error Response:", err.response?.data);
        alert(err.response?.data?.message || "Failed to save food. Check server logs.");
    }
};
